...
import { useMemberSubscription } from "@/lib/hooks/use-subscription"
import { useState } from "react"

export function SubscriptionAlertBanner() {
  const { hasActiveSubscription, isLoading } = useMemberSubscription()
    ...
    <Alert variant="destructive" className="rounded-none border-x-0 border-t-0 mb-0">
      ...
      <div className="flex items-center justify-between flex-1">
        <div className="flex-1">
          ...
          <AlertDescription>
            Your subscription has expired or is inactive. Please subscribe to continue using all features.
          </AlertDescription>
        </div>
