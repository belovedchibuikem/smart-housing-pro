...
import { downloadMortgageRepaymentTemplate, uploadBulkMortgageRepayments } from "@/lib/api/client"
...
export default function BulkUploadMortgageRepaymentsPage() {
	...
	const handleUpload = async () => {
		...
		try {
			const result = await uploadBulkMortgageRepayments(file)
			...
			sonnerToast.error("Upload Failed", {
				description: error.message || "Failed to upload mortgage repayments. Please check the file format and try again.",
			})
		} finally {
			setUploading(false)
		}
