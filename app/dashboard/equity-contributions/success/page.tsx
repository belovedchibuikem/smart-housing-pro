...
export default function EquityContributionSuccessPage() {
  ...
  const method = methodParam?.replace(/_/g, " ").replace(/\b\w/g, (char) => char.toUpperCase()) ?? "Not specified"
      ...
      <Card className="w-full max-w-2xl space-y-8 p-8 md:p-12">
        <div className="flex justify-center">
          <div
            className={[
              ...
              awaitingApproval ? "bg-amber-100 dark:bg-amber-900/20" : "bg-green-100 dark:bg-green-900/20",
            ].join(" ")}
          >
            {awaitingApproval ? (
        ...
        <div className="text-center space-y-2">
          <h1 className="text-3xl font-bold">
            {awaitingApproval ? "Contribution Submitted" : "Equity Contribution Recorded"}
          </h1>
          <p className="text-muted-foreground text-lg">
            {awaitingApproval
              ? infoParam ?? "Your contribution has been received and is awaiting confirmation by the finance team."
              : "Thank you! Your equity contribution has been recorded successfully."}
          </p>
        </div>
        ...
        <div className="rounded-lg border bg-muted/40 p-6 space-y-3 text-sm">
          ...
          <div className="flex justify-between">
            ...
            <span className={awaitingApproval ? "font-medium text-amber-600" : "font-medium text-green-600"}>
        ...
        <ReceiptDownloadButton
          ...
          data={{
            title: "Equity Contribution Receipt",
            subtitle: awaitingApproval ? "Contribution Submitted" : "Contribution Payment",
            ...
            footerNote:
              "Thank you for investing in your equity contribution. Keep this receipt safe as evidence of your payment.",
          }}
        />

        <div className="space-y-3">
          <Link href="/dashboard/equity-contributions" className="block">
            <Button className="w-full" size="lg">
              <Home className="h-4 w-4 mr-2" />
              Back to Equity Contributions
            </Button>
          </Link>
