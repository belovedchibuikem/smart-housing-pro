 ...
 */
export const PROPERTY_BULK_UPLOAD_CSV = `Title,Description,Location,Address,City,State,Property Type,Price (per slot),Size (sqft),Bedrooms,Bathrooms,Total Slots,Status (available/reserved/sold),Features (comma-separated)
